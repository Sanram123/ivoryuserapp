...
class ProfileCompleteGender extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            male: false,
    ...
    callProfileCompleteAddress = () => {
        // this.props.navigation.navigate('ProfileCompleteAddess');
        console.log(Global.profileInfo)
    }
    ...
    register = () => {
        if(this.state.male || this.state.female || this.state.others){
        fetch(Global.BASE_URL + 'userInfo/signup/user/', {
            method: 'POST',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json'
            },
            body: JSON.stringify(Global.profileInfo)
        })
        ...
        console.log('clicked register')
            ...
            this.showAlert('Alert!!', 'Please choose gender')
        }
    }

    selectedGender = (gender) => {
        console.log(gender)
        Global.profileInfo["gender"] = gender
        switch (gender) {
            case "0":
                    ...
                    <View style={stylesheet.continueView}>
                        <TouchableOpacity onPress={this.register}>
                            <View style={stylesheet.continueButton}>
                                <Text style={stylesheet.continueTitle}>Register</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
...
export default ProfileCompleteGender;
